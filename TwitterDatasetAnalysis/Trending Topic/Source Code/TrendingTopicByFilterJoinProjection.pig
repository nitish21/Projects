...
-- Filter out all empty HashTags in tweets
filteredTweets = FILTER tweets BY (HashTags != '##NOTHING##');
...
userTweetsWithLocationHashTags = FOREACH userTweets GENERATE UserId, Location, HashTags;
